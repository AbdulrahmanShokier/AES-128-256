...
// currently the carrier frequency is the clk_sample divided by 1024 (because we have 256 value for one quarter in the cos wave )
// for another carrier frequency we have to use another clock or change the phase accumator increament 
